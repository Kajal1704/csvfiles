...
for j = 1:len
    ...
    z2(j+1) = x2(j+1) + y2(j+1);  


end
toc

x2(1)=[]; %Exclude the first term in x2 (i.e. starting point)
y2(1)=[]; %Exclude the first term in y2 (i.e. starting point)
z2(1)=[]; %Exclude the first term in z2 (i.e. starting point)
...
glcm1 = graycomatrix(z2_2,'Offset',[0 1]) %%% default offset [0 1], Angle 0 Degree
...
glcm2 = graycomatrix(z2_2,'Offset',[1 0]);  %%% offset [1 0], Angle 180 Degree
...
glcm3 = graycomatrix(z2_2,'Offset',[0 0]);  
...
glcm4 = graycomatrix(z2_2,'Offset',[-1 1]); %%% offset [-1 1], Angle 45 Degree
...
glcm5 = graycomatrix(z2_2,'Offset',[-1 0]); %%% offset [-1 0], Angle 90 Degree
...
glcm6 = graycomatrix(z2_2,'Offset',[-1 -1]); %%% offset [-1 -1], Angle 135 Degree
...
glcm7 = graycomatrix(z2_2,'Offset',[1 -1]); %%% offset [1 -1], Angle 225 Degree
...
glcm8 = graycomatrix(z2_2,'Offset',[0 -1]); %%% offset [0 -1], Angle 270 Degree
...
glcm9 = graycomatrix(z2_2,'Offset',[1 1]); %%% offset [1 1], Angle 315 Degree
...
z1_ent=entropy(z2_2);
z1_mean=mean(z2_2);
z1_median=median(z2_2);
z1_stand_dev=std(z2_2);
