...
%%%%%%%%%%%  Chaos Game Representation - CGR-walk CGR-WS %%%%%%%%
tic
x3(1) = 0.5; y3(1) = 0.5;
z3(1) = x3(1) + y3(1);
...
x3(1)=[]; %Exclude the first term in x1 (i.e. starting point)
y3(1)=[]; %Exclude the first term in y1 (i.e. starting point)
z3(1)=[]; %Exclude the first term in z1 (i.e. starting point)
...
glcm1 = graycomatrix(z3_1,'Offset',[0 1]) %%% default offset [0 1], Angle 0 Degree
...
glcm2 = graycomatrix(z3_1,'Offset',[1 0]);  %%% offset [1 0], Angle 180 Degree
...
glcm3 = graycomatrix(z3_1,'Offset',[0 0]);  
...
glcm4 = graycomatrix(z3_1,'Offset',[-1 1]); %%% offset [-1 1], Angle 45 Degree
...
glcm5 = graycomatrix(z3_1,'Offset',[-1 0]); %%% offset [-1 0], Angle 90 Degree
...
glcm6 = graycomatrix(z3_1,'Offset',[-1 -1]); %%% offset [-1 -1], Angle 135 Degree
...
glcm7 = graycomatrix(z3_1,'Offset',[1 -1]); %%% offset [1 -1], Angle 225 Degree
...
glcm8 = graycomatrix(z3_1,'Offset',[0 -1]); %%% offset [0 -1], Angle 270 Degree
...
glcm9 = graycomatrix(z3_1,'Offset',[1 1]); %%% offset [1 1], Angle 315 Degree
...
z1_ent=entropy(z3_1);
z1_mean=mean(z3_1);
z1_median=median(z3_1);
z1_stand_dev=std(z3_1);
