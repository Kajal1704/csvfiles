...
%%%%%%%%%%%  Thermodynamic Property representation %%%%%%%%
tic
T=zeros(len-1,1);
for i=1:len-1
    a=seqs(i);
...
Thrmodynmc_reprstn=T
toc
 
%%%%% Feature extraction %%%%%%%%%%
%glcm=graycomatrix(z1,'Offset',[0 1;1 0]);

glcm1 = graycomatrix(Thrmodynmc_reprstn,'Offset',[0 1]) %%% default offset [0 1], Angle 0 Degree
...
glcm2 = graycomatrix(Thrmodynmc_reprstn,'Offset',[1 0]);  %%% offset [1 0], Angle 180 Degree
...
glcm3 = graycomatrix(Thrmodynmc_reprstn,'Offset',[0 0]);  
...
glcm4 = graycomatrix(Thrmodynmc_reprstn,'Offset',[-1 1]); %%% offset [-1 1], Angle 45 Degree
...
glcm5 = graycomatrix(Thrmodynmc_reprstn,'Offset',[-1 0]); %%% offset [-1 0], Angle 90 Degree
...
glcm6 = graycomatrix(Thrmodynmc_reprstn,'Offset',[-1 -1]); %%% offset [-1 -1], Angle 135 Degree
...
glcm7 = graycomatrix(Thrmodynmc_reprstn,'Offset',[1 -1]); %%% offset [1 -1], Angle 225 Degree
...
glcm8 = graycomatrix(Thrmodynmc_reprstn,'Offset',[0 -1]); %%% offset [0 -1], Angle 270 Degree
...
glcm9 = graycomatrix(Thrmodynmc_reprstn,'Offset',[1 1]); %%% offset [1 1], Angle 315 Degree
...
z1_ent=entropy(Thrmodynmc_reprstn);
z1_mean=mean(Thrmodynmc_reprstn);
z1_median=median(Thrmodynmc_reprstn);
z1_stand_dev=std(Thrmodynmc_reprstn);
