...
glcm1 = graycomatrix(Atomic_reprstn,'Offset',[0 1]) %%% default offset [0 1], Angle 0 Degree
...
glcm2 = graycomatrix(Atomic_reprstn,'Offset',[1 0]);  %%% offset [1 0], Angle 180 Degree
...
glcm3 = graycomatrix(Atomic_reprstn,'Offset',[0 0]);  
...
glcm4 = graycomatrix(Atomic_reprstn,'Offset',[-1 1]); %%% offset [-1 1], Angle 45 Degree
...
glcm5 = graycomatrix(Atomic_reprstn,'Offset',[-1 0]); %%% offset [-1 0], Angle 90 Degree
...
glcm6 = graycomatrix(Atomic_reprstn,'Offset',[-1 -1]); %%% offset [-1 -1], Angle 135 Degree
...
glcm7 = graycomatrix(Atomic_reprstn,'Offset',[1 -1]); %%% offset [1 -1], Angle 225 Degree
...
glcm8 = graycomatrix(Atomic_reprstn,'Offset',[0 -1]); %%% offset [0 -1], Angle 270 Degree
...
glcm9 = graycomatrix(Atomic_reprstn,'Offset',[1 1]); %%% offset [1 1], Angle 315 Degree
...
z1_ent=entropy(Atomic_reprstn);
z1_mean=mean(Atomic_reprstn);
z1_median=median(Atomic_reprstn);
z1_stand_dev=std(Atomic_reprstn);
