...
%M(1)=[]; %%%% Exclude the first term 'zero'%%%%
Molecular_Mass_reprstn=M;
MM_reprstn=M
toc
...
glcm1 = graycomatrix(Molecular_Mass_reprstn,'Offset',[0 1]) %%% default offset [0 1], Angle 0 Degree
...
glcm2 = graycomatrix(Molecular_Mass_reprstn,'Offset',[1 0]);  %%% offset [1 0], Angle 180 Degree
...
glcm3 = graycomatrix(Molecular_Mass_reprstn,'Offset',[0 0]);  
...
glcm4 = graycomatrix(Molecular_Mass_reprstn,'Offset',[-1 1]); %%% offset [-1 1], Angle 45 Degree
...
glcm5 = graycomatrix(Molecular_Mass_reprstn,'Offset',[-1 0]); %%% offset [-1 0], Angle 90 Degree
...
glcm6 = graycomatrix(Molecular_Mass_reprstn,'Offset',[-1 -1]); %%% offset [-1 -1], Angle 135 Degree
...
glcm7 = graycomatrix(Molecular_Mass_reprstn,'Offset',[1 -1]); %%% offset [1 -1], Angle 225 Degree
...
glcm8 = graycomatrix(Molecular_Mass_reprstn,'Offset',[0 -1]); %%% offset [0 -1], Angle 270 Degree
...
glcm9 = graycomatrix(Molecular_Mass_reprstn,'Offset',[1 1]); %%% offset [1 1], Angle 315 Degree
...
z1_ent=entropy(Molecular_Mass_reprstn);
z1_mean=mean(Molecular_Mass_reprstn);
z1_median=median(Molecular_Mass_reprstn);
z1_stand_dev=std(Molecular_Mass_reprstn);
